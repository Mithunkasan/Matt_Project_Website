    ...
    <div className="w-full max-w-4xl mx-auto bg-white rounded-lg p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <span className={`text-sm font-medium ${step === 1 ? 'text-[#12498b]' : 'text-gray-400'}`}>
            Step 1: Basic Information
          </span>
          <span className={`text-sm font-medium ${step === 2 ? 'text-[#12498b]' : 'text-gray-400'}`}>
            Step 2:
          </span>
        </div>
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            className="bg-[#12498b] h-2 rounded-full transition-all duration-300"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {step === 1 ? (
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-[#12498b]/5 to-transparent p-4 rounded-lg border-l-4 border-[#12498b]">
              <h3 className="font-semibold text-gray-900 mb-1 flex items-center gap-2">
                <Building2 className="w-5 h-5 text-[#12498b]" />
                Project Basic Information
              </h3>
              <p className="text-sm text-gray-600">Fill in the essential project details</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="w-full h-11 border-gray-300 focus:border-[#12498b] focus:ring-[#12498b]/20 transition-all text-black"
                  value={formData.name}
              ...
              <div className="space-y-2">
                <Label htmlFor="handler" className="text-sm font-semibold text-black">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="w-full h-11 pl-10 border-gray-300 focus:border-[#12498b] focus:ring-[#12498b]/20 transition-all text-black"
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-end pt-4 border-t border-gray-200">
              ...
              <Button
                ...
                className="w-full sm:w-auto bg-[#16539b] hover:bg-[#1858a3] text-white"
              >
                Next Step
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-[#12498b]/5 to-transparent p-4 rounded-lg border-l-4 border-[#12498b]">
              <h3 className="font-semibold text-gray-900 mb-1 flex items-center gap-2">
                <TrendingUp className="w-5 h-5 text-[#12498b]" />
                Project Details & Payment
              </h3>
              <p className="text-sm text-gray-600">Complete the project information and payment details</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-2">
                <Label htmlFor="student" className="text-sm font-semibold text-black">
              ...
              <div className="space-y-2">
                <Label htmlFor="studentEmail" className="text-sm font-semibold text-black">
